...
<Meta title="Breadcrumbs/Usage" component={Breadcrumbs} />
...
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| title?    | Component or string to display in breadcrumbs and submenus Defaults to capitalized slug.                                                        | false    |
| label?    | String for aria-labels when title is a a component. Leave undefined for string titles. Defaults to string title or slug.                        | false    |
...
const routes = {
    ...
    label: 'Home', // Label for aria-labels since the title is a component. Leave undefined when using string titles.
